        ...
        <div className="w-full max-w-md p-8 bg-purple-950 rounded-lg shadow-md dark:bg-gray-800">
          ...
          <div className="mt-6 mr-4 flex flex-col sm:flex-row items-center sm:items-start sm:space-x-4">
            <button
              onClick={handler}
              type="submit"
              className="text-black mt-8 mb-8 p-2 text-xl font-bold bg-purple-400 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 rounded-lg px-4 py-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800 sm:mt-0"
            >
              Search
            </button>
            <button
